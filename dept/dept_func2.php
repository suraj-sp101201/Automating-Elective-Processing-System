...
<div class="sidebar">
  ...
  <div class=print-css>
<h1 style="text-align:center; color: black;">STUDENTS LIST </h1>
<table class="center">
<tr>
<th>Name</th>
<th>Roll Number</th>
...
<?php
$sql = "SELECT s.studentName, s.rollNo, p.programName, d.departmentName, s.yearOfJoining FROM Department d, Programs p, Student s WHERE s.programId = p.programId AND p.deptId = d.deptId";
$result = mysqli_query($conn,$sql);
if($result->num_rows >0) 
{
while($row=$result->fetch_assoc()) {
echo "<tr><td>" . $row["studentName"]. "</td><td>" . $row["rollNo"] . "</td><td>"
. $row["programName"]. "</td><td>". $row["departmentName"]. "</td><td>". $row["yearOfJoining"]."</td></tr>";
}
echo "</table>";
