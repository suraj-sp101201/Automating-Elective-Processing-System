...
<div class="main-block">
        ...
        if (isset($_POST['submit']))
        {
          ...
          $id = $_SESSION['processid'];
          //echo $id;
          //echo $studentId;
          $q1 = "SELECT * FROM StudentPreference WHERE studentId=$studentId AND processId=$id";
          ...
          foreach($result as $row)
          {
            ...
            $offerId = $row["offerId"];
            //$studentId = $userid;
            //echo $_POST['Software_Engineering'];
            //echo '<h3> '.$row["courseName"].'</h3>';
            $preference = $_POST[$row["offerName"]];
            //echo $processId;
            //echo $offerId;
            //echo $studentId;
            //echo $preference;
            $sql_insert = "INSERT INTO StudentPreference(processId,offerId,studentId,preferenceNumber) VALUES ('$processId', '$offerId','$studentId','$preference')";
      ...
      {
        echo '<script>alert("Some Failure Retry")</script>'; 
      }
    }
    }
      else{
        echo '<script>alert("RECORDS ALREADY FOUND")</script>'; 
      }
