...
<h1 style="text-align:center; color: black;">ELECTIVE COURSES </h1>
<table class="center">
<tr>
<th>Course</th>
<th>Program</th>
...
<?php
$sql = "SELECT c.courseName, p.programName, d.departmentName, c.credits FROM Department d, Programs p, Courses c WHERE c.programId = p.programId AND p.deptId = d.deptId";
$result = mysqli_query($conn,$sql);
if($result->num_rows >0) 
{
while($row=$result->fetch_assoc()) {
echo "<tr><td>" . $row["courseName"]. "</td><td>" . $row["programName"] . "</td><td>"
. $row["departmentName"]. "</td><td>". $row["credits"]. "</td></tr>";
}
echo "</table>";
